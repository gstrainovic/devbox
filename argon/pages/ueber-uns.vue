            ...
            <div class="container">
                <div class="row mb-lg">
                    <div class="col-lg-8">
                        ...
                        für die Informationstechnolgie, auch bekannt als IT oder ICT an, wie z. B:</h3>
                        <ul>
                          <br>
                        ...
                        <h3 class="lead ">Wir untestützen sowohl Private auch als KMU,
                        Firmen, Start-ups, AG, GmbH bei allen digitalen Herausforderungen, wie z.B:
                        </h3>
                    </div>
                </div>
                <div class="row">
                  ...
                  <div class="col">
                    <ul>
                      ...
                      <li>Betriebssysteme wie z. B:</li>
                        ...
                        <li>Office, VBA, Word, Excel, Access, Outlook, Email & Powerpoint</li>
                ...
                <div class="row mb-lg">
                    <div class="col-lg-8">
                        <h3 class="lead ">
                        Die meisten Projekte werden direkt vom Gründer, Goran Strainovic umgesetzt.
                        Grössere Projekte werden bei Bedarf mit Partner umgesetzt.
                        </h3>
                    </div>
                </div>
              <div class="row mb-5 ">
            ...
            <div class="container pt-lg pb-100">
              ...
              <div class="row mb-5 text-white">
                <div class="col-lg-12">
                  ...
                  <p class="lead mb-5">Prüfen, Reparieren, Avor, Technischer Support von Elektronik Baugruppen</p>
                  <h4 class="display-4 text-white mt-5">Als Gründer & Projektmanager</h4>
                  <p class="lead">Akquise, Analysieren, Konzepterstellung, Beraten, Planen, Managen, Schulen</p>
                  <h4 class="display-4 mt-5 text-white">Als Softwarentwickler & UI / UX Designer</h4>
                  <p class="lead mb-5">Designen, Programmieren, Installieren, Konfigurieren, Erweitern, Warten, Testen</p>
                </div>
              </div>
            <!-- </div> -->
              ...
              <div class="row mb-5 text-white">
                <div class="col-lg-12">
                  ...
                  <h4 class="display-4 text-white mt-5">Informatik – Anwender SIZ</h4>
                  <p class="lead">Berufsschule Uzwil<br>2000 – 2001</p>
                  <h4 class="display-4 mt-5 text-white">Praktikum als RTV- Elektriker</h4>
              ...
              <div class="row mb-5 text-white">
                <div class="col-lg-12">
                  <h3 class="display-3 text-white">Von mir umgesetzte Projekte</h3>
                  <h4 class="display-4 mt-5 text-white">Zeitersparnis durch Automatisierungen</h4>
                  ...
                  <p>Die von mir erstellten Webseiten finden Sie im <nuxt-link class="text-white" to=/portfolio/web><b>Portfolio</b></nuxt-link>

                  <h4 class="display-4 mt-5 text-white">Softwareentwicklung</h4>
                  <h5 class="display-5 mt-4 text-white">rBranches für einen österreichischen Kunden</h5>
                  <h6 class="display-6 mt-3 text-white">Ziel</h6>
                  <p>Programmierung eines D-A-CH Branchenverzeichnisses im Team</p>
                  <h6 class="display-6 mt-3 text-white">Technologien</h6>
                  <p>R mit RStudio</p>

                  <h5 class="display-5 mt-4 text-white">Plugin für einen deutschen Kunden</h5>
                  <h6 class="display-6 mt-3 text-white">Ziel</h6>
                  <p>Unbenötige Formularfelder in Shopware bei der Registrierung deaktivieren</p>
                  <h6 class="display-6 mt-3 text-white">Technologien</h6>
                  <p>PHP</p>

                  <h4 class="display-4 mt-5 text-white">Schulungen</h4>
                  <h5 class="display-5 mt-4 text-white">Schulung beim Kunden in Zürich</h5>
                  <h6 class="display-6 mt-3 text-white">Ziel</h6>
                  <p>Basics der Webseitenerstellung</p>
                  <h6 class="display-6 mt-3 text-white">Technologien</h6>
                  <p>WordPress, Divi</p>

                  <h5 class="display-5 mt-4 text-white">Schulung eines Kunden aus St.Gallen</h5>
                  <h6 class="display-6 mt-3 text-white">Ziel</h6>
                  <p>Basics der Programmierung</p>
                  <h6 class="display-6 mt-3 text-white">Technologien</h6>
                  <p>F# (FSharp), Visual Studio</p>

                  <h4 class="display-4 mt-5 text-white">Installation und Konfiguration</h4>
                  <h5 class="display-5 mt-4 text-white">Strainovic IT</h5>
                  <h6 class="display-6 mt-3 text-white">Ziel</h6>
        ...
        <!-- <section class="section section-lg pt-5"> -->
            <!-- <div class="container"> -->
                <!-- <card gradient="warning" -->
                      <!-- no-bodyy-4 mt-5 text-white">Praktikum als RTV- Elektriker</h4>
                  <p class="lead mb-5">RTV Bohren Gossau<br>1998 - 1999</p>
                </div>
              </div>
            </div>
