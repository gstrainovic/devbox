<template>
    <div>
        ...
        <section class="section section section-shaped my-0 overflow-hidden" id="software-und-apps">
        ...
        <section class="section section-lg" id="webdesign-und-programmierung">
            <div class="container">
        ...
        <section class="section section section-shaped my-0 overflow-hidden" id="marketing">
