            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Referenzen & Portfolio
                                    <span>Webdesign</span>
                                </h1>
                            </div>
                        </div>
                ...
                <div class="row mb-lg mt-5">
                  <div class="container container-lg">
                      <div class="row">
                                  ...
                                  <div class="card-body">
                                     <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                              <th>Link</th>
                                              <td><a href="http://buegeln.services" target="_blank">http://buegeln.services</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                  </div>
                                  ...
                                  <div class="card-body">
                                     <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                              <th>Link</th>
                                              <td><a href="http://grav.gost.pw/mijajlovic.ch" target="_blank">http://grav.gost.pw/mijajlovic.ch</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                  </div>
                                 ...
                                 <div class="card-body">
                                     <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                              <th>Link</th>
                                              <td><a href="http://grav.gost.pw/susanne" target="_blank">http://grav.gost.pw/susanne</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                  </div>
                          ...
                          <div class="col-md-6 mb-5 mb-lg-0 mt-5">
                              <div class="card card-lift--hover shadow border-0">
                                  <a href="https://gstrainovic.github.io/gost.pw" target="_blank">
                                  ...
                                  <div class="card-body">
                                     <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                              <th>Link</th>
                                              <td><a href="https://gstrainovic.github.io/gost.pw" target="_blank">https://gstrainovic.github.io/gost.pw</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                  </div>
                                  ...
                                  <div class="card-body">
                                     <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                              <th>Link</th>
                                              <td><a href="http://old-wp.strainovic-it.ch" target="_blank">http://old-wp.strainovic-it.ch</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                  </div>
